            ...
            for (int i = 0; i < citiesArr.length(); i++) {
                ...
                for(int r = 0; r < monumentsArr.length(); r++) {
                    ...
                    monuments.add(new MonumentItem(
                            ...
                            context.getResources().getIdentifier(monument.getString("bitmap_locked"), "drawable", context.getPackageName()),
                            context.getResources().getIdentifier(monument.getString("bitmap_unlocked"), "drawable", context.getPackageName()),
